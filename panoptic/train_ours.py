...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/home/huanghanyang/Project/yolov9/models/panoptic/gelan-c-pan.yaml', help='model.yaml path')
    # parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg.yaml', help='dataset.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/rack.yaml', help='dataset.yaml path')
