...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default='/home/huanghanyang/Project/yolov9/gelan-c-pan.pt', help='initial weights path')
    parser.add_argument('--weights', type=str, default='/home/huanghanyang/Project/yolov9/runs/train-pan/strawberry_rack_v2/weights/yolov9-pan-strawberry7cls_rackcls1_v2.pt', help='initial weights path')

    parser.add_argument('--cfg', type=str, default='/home/huanghanyang/Project/yolov9/models/panoptic/gelan-c-pan-rack-v1-1.yaml', help='model.yaml path')
    # parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg.yaml', help='dataset.yaml path')

    parser.add_argument('--data', type=str, default=ROOT / 'data/rack-v4_0.yaml', help='dataset.yaml path')

    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-high_rack_v2.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--save-period', type=int, default=30, help='Save checkpoint every x epochs (disabled if < 1)')
